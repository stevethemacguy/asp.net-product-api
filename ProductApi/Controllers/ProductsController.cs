...
namespace ProductApi.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        [HttpPost("")]
        public IActionResult CreateProduct([FromBody] ProductForCreation product)
        {
            ...
            // See if the product that was passed already exists in the database
            var theProductExists = _productRepo.ProductExists(finalproduct.Id);

            if (theProductExists)
            {
                ModelState.AddModelError("Duplicate ID", "A Product with this ID already exists in the database");
                return BadRequest(ModelState);
            }

            _productRepo.AddProduct(finalproduct);
            ...
            var newlyCreatedProduct = AutoMapper.Mapper.Map<Models.Product>(finalproduct);
            ...
            return CreatedAtRoute("GetProductByID",
                                   new { id = newlyCreatedProduct.Id},newlyCreatedProduct);
        }
